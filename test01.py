...
text2 = "Vice President Johnson, Mr. Speaker, Mr. Chief Justice, President Eisenhower,\
...
the burden of a long twilight struggle, year in and year out, -- a struggle against the common enemies of man:\
...
profile = personality_insights.profile(
    content=text2, content_type='text/plain', raw_scores=True, consumption_preferences=True)
